...
Q_CONSTINIT static const qt_meta_stringdata_CLASSFileManagerENDCLASS_t qt_meta_stringdata_CLASSFileManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 15),  // "operationStatus"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 7),  // "message"
        QT_MOC_LITERAL(37, 7)   // "isError"
    },
    "FileManager",
    "operationStatus",
    "",
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->operationStatus((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FileManager::*)(const QString & , bool );
            if (_t _q_method = &FileManager::operationStatus; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileManager::operationStatus(const QString & _t1, bool _t2)
{
